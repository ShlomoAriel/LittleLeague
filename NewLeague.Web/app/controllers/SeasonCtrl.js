var SeasonCtrl = function ($scope, $location, Seasons, CommonServices, TeamService, $rootScope, $state, $stateParams, $http) {
    ...
    $scope.addTeamToSeason = function () {
        ...
        $http.post('http://localhost:55506///api/Match/AddTeamToSeason', SeasonTeam).success(function (data) {
        ...
        $http.post('http://localhost:55506///api/Match/DeleteTeamFromSeason', seasonTeam).success(function () {
            CommonServices.getSeasons();
            $scope.deletedAlert();
